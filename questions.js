(function(){
  ...
  const SKILLS = {
    ...
    'Social Studies':[
      'Primary & Secondary Sources','Cause & Effect','Geography','Civics','Ancient Civilizations','U.S. History','Economics','Historical Reasoning'
    ],
  ...
  window.A22_BANK={SKILLS,english,science,social,reasoning,reading,readingSets,mathQuestion,mulberry32,pick,shuffle};
})();
